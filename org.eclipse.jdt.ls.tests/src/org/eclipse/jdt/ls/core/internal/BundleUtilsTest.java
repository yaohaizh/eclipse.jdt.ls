...
public class BundleUtilsTest extends AbstractProjectsManagerBasedTest {
	...
	public void testLoadUnload() {
		...
		InitHandler.initializeParticipants(result);
		assertEquals("TEST_VALUE", result.getParticipantData().get("TEST_KEY"));
	}

	private String getBundle() {
		return (new File("testresources", "testbundle-0.4.0-SNAPSHOT.jar")).getAbsolutePath();
	}
