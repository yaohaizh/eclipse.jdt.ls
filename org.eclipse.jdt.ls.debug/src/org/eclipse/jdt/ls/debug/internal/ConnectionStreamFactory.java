...
public class ConnectionStreamFactory {
	...
	//
	// public DualSocketStreamProvider(String readHost, int readPort, String
	// writeHost, int writePort) {
	...
	// /* (non-Javadoc)
	// * @see
	// org.eclipse.jdt.ls.core.internal.ConnectionStreamFactory.StreamProvider#getInputStream()
	// */
	// @Override
	// public InputStream getInputStream() throws IOException {
	...
	// /* (non-Javadoc)
	// * @see
	// org.eclipse.jdt.ls.core.internal.ConnectionStreamFactory.StreamProvider#getOutputStream()
	// */
	// @Override
	// public OutputStream getOutputStream() throws IOException {
	...
	private StreamProvider createProvider() {
		...
		// if (port != null) {
		return new SocketStreamProvider("localhost", 8124);
		// }
		...
		// JavaLanguageServerPlugin.logError("STDIN_PORT and STDOUT_PORT will be
		// removed in the next release. Please use CLIENT_PORT instead (single
		// connection for both in and output)");
		// return new DualSocketStreamProvider(rHost, Integer.parseInt(rPort),
